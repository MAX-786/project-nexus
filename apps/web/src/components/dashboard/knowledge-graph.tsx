...
function KnowledgeGraphInner({
  ...
  return (
    <div className="h-full w-full relative" role="region" aria-label="Knowledge graph visualization">
      ...
      {/* Graph Legend */}
      <div className="absolute bottom-4 left-4 z-10 rounded-xl bg-card/90 backdrop-blur-sm border border-border/50 px-4 py-3 shadow-lg max-w-[200px]" role="note" aria-label="Graph legend">
